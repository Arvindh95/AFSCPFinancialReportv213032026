...
| [MBRReport_Generation.md](MBRReport_Generation.md) | FR101003 | **Current** | AI-driven Monthly Board Report (`.pptx`) generation via Gamma. Consumes the placeholders emitted by Report Definitions and MBR Definitions. Was `archive/old-manuals/05_Presentation_Generation.md`. |
