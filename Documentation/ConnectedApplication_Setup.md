# onnected Application Setup — OAuth2 Client Credentials
...
![Connected Applications screen](images/connected_app_01.png)
...
![Enter Client Name](images/connected_app_02_client_name.png)
...
![Flow dropdown open](images/connected_app_03_flow_dropdown.png)

![Flow selected](images/connected_app_04_flow_selected.png)
...
![Saved with Client ID](images/connected_app_05_saved_client_id.png)
...
![Add Shared Secret popup](images/connected_app_06_add_secret_popup.png)
...
![Secret details filled](images/connected_app_07_secret_description.png)

![Secret expiry and value](images/connected_app_08_secret_expiry_value.png)
...
![Secret added to grid](images/connected_app_09_secret_added.png)
...
![Final saved state](images/connected_app_10_final_saved.png)
