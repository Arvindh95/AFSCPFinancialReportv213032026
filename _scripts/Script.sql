...
BEGIN
    ...
    CREATE TABLE [dbo].[FLRTReportDefinition] (
        ...
        [MovementColumn]         [nvarchar](100)    NOT NULL DEFAULT('Movement'),
        [PeriodColumn]           [nvarchar](100)    NOT NULL DEFAULT('FinancialPeriod'),
        [SubaccountColumn]       [nvarchar](100)    NOT NULL DEFAULT('Subaccount'),
        [BranchColumn]           [nvarchar](100)    NOT NULL DEFAULT('BranchID'),
        [OrganizationColumn]     [nvarchar](100)    NOT NULL DEFAULT('OrganizationID'),
        [LedgerColumn]           [nvarchar](100)    NOT NULL DEFAULT('LedgerID'),
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[FLRTReportDefinition]') AND name = N'MovementColumn')
        ALTER TABLE [dbo].[FLRTReportDefinition] ADD [MovementColumn] [nvarchar](100) NOT NULL DEFAULT('Movement');

    IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[FLRTReportDefinition]') AND name = N'PeriodColumn')
        ALTER TABLE [dbo].[FLRTReportDefinition] ADD [PeriodColumn] [nvarchar](100) NOT NULL DEFAULT('FinancialPeriod');

    IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[FLRTReportDefinition]') AND name = N'SubaccountColumn')
        ALTER TABLE [dbo].[FLRTReportDefinition] ADD [SubaccountColumn] [nvarchar](100) NOT NULL DEFAULT('Subaccount');

    IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[FLRTReportDefinition]') AND name = N'BranchColumn')
        ALTER TABLE [dbo].[FLRTReportDefinition] ADD [BranchColumn] [nvarchar](100) NOT NULL DEFAULT('BranchID');

    IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[FLRTReportDefinition]') AND name = N'OrganizationColumn')
        ALTER TABLE [dbo].[FLRTReportDefinition] ADD [OrganizationColumn] [nvarchar](100) NOT NULL DEFAULT('OrganizationID');

    IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[FLRTReportDefinition]') AND name = N'LedgerColumn')
        ALTER TABLE [dbo].[FLRTReportDefinition] ADD [LedgerColumn] [nvarchar](100) NOT NULL DEFAULT('LedgerID');
