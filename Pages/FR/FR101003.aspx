<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormTab.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="FR101003.aspx.cs" Inherits="Page_FR101003" Title="Financial Presentation" %>
<%@ MasterType VirtualPath="~/MasterPages/FormTab.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
		TypeName="FinancialReport.FLRTFinancialPresentationMaint"
		PrimaryView="PresentationRecord">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView Width="100%" DataMember="PresentationRecord" runat="server" ID="PresentationForm" DataSourceID="ds"
		NoteID="Noteid" ActivityIndicator="True">
		<Template>
			<px:PXLayoutRule runat="server" ID="rl_Row1" StartRow="True" />

			<%-- Column 1: Presentation Info --%>
			<px:PXLayoutRule runat="server" ID="rl_Col1" StartColumn="True" LabelsWidth="S" ControlSize="M" />
			<px:PXTextEdit  runat="server" ID="edPresentationCD"   DataField="PresentationCD" />
